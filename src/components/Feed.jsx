    ...
    <div className="feed">
             ...
             <div className="feed_options">
                  <div className="option">
                    <InsertPhotoIcon style={{color:'#C70039'}} className="icon"/>
                    <span>Photo</span>
                  </div>
                  <div className="option" style={{color:'#FF5733'}}>
                    <YouTubeIcon className="icon"/>
                    <span>Video</span>
                  </div>
                  <div className="option" style={{color:'#FFBD33'}}>
                    <EventIcon className="icon"/>
                    <span>Event</span>
                  </div>
                  <div className="option"  style={{color:'#E26B52'}}>
       ...
       <Post name="Piyush Yadav" desription="I am Web Developer" message="We are Learning React JS" photoURL="https://png.pngtree.com/png-vector/20190710/ourmid/pngtree-user-vector-avatar-png-image_1541962.jpg"/>
